...
import { attachToUploadArea, UploadFile } from "../_support/uploads";
...
export class SubmissionsPage {
   ...
   */
  async uploadSubmission(file: UploadFile = "e2e/files/manuscript.pdf") {
    ...
    await attachToUploadArea(this.page, SUBMISSION_FORM, file);
    ...
    const fileName = typeof file === "string" ? file.split("/").at(-1) ?? file : file.name;

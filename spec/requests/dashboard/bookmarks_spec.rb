...
RSpec.describe("Dashboard::Bookmarks", type: :request) do
  ...
  describe "POST /dashboard/lectures/:lecture_id/bookmark" do
    it "bookmarks a published lecture and re-renders the dashboard bands" do
      post dashboard_lecture_bookmark_path(lecture), as: :turbo_stream
    ...
    it "scopes the re-rendered bands to the given term" do
      ...
      post dashboard_lecture_bookmark_path(lecture),
    ...
    it "refuses an unpublished lecture" do
      ...
      post dashboard_lecture_bookmark_path(draft), as: :turbo_stream
    ...
    it "404s for an unknown lecture" do
      post dashboard_lecture_bookmark_path(0), as: :turbo_stream

      expect(response).to have_http_status(:not_found)
    end
  end

  describe "DELETE /dashboard/lectures/:lecture_id/bookmark" do
    it "removes a bookmark and re-renders the dashboard bands" do
      user.bookmark_lecture!(lecture)

      delete dashboard_lecture_bookmark_path(lecture), as: :turbo_stream

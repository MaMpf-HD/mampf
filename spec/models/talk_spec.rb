...
RSpec.describe Talk, type: :model do
  ...
  context "title methods" do
    before :all do
      ...
      lecture = FactoryBot.build(:lecture, course:, term:)
      FactoryBot.create(:talk, lecture:, title: "total bs")
      @talk = FactoryBot.create(:talk, lecture:,
                                       title: "even more bs")
    end
  ...
  describe "#media_scope" do
    it "returns the lecture associated to the talk" do
      ...
      talk = FactoryBot.build(:talk, lecture:)
  ...
  context "position methods" do
    before :all do
      ...
      @talk1 = FactoryBot.create(:talk, lecture:)
      @talk2 = FactoryBot.create(:talk, lecture:)
      @talk3 = FactoryBot.create(:talk, lecture:)
    end
    ...
    describe "#card_header_path" do
      it "returns the path for the talk if the user is subscribed to the " \
        ...
        talk = FactoryBot.create(:valid_talk, lecture:)

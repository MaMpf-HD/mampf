...
RSpec.describe SubmissionCleaner, type: :model do
  ...
  context 'with sample submissions' do
    ...
    describe '#clean!' do
      ...
      it 'does sends deletion info mail on first day of next term' do
        cleaner = FactoryBot.build(:submission_cleaner,
                                   date: Date.parse('1.4.2021'))
        cleaner.clean!
        @term.reload
      ...
      it 'does sends deletion reminder mail one week later' do
      ...
      it 'destroys submissions and sends an email two weeks later (part 1)' do
        @term.submission_deletion_mail = DateTime.parse('1.4.2021 3:00')
      ...
      it 'destroys submissions and sends an email two weeks later (part 2)' do
        # test if submission1 - submission 3 were indeed destroyed
        # (and submission21 is still alive)
      end
    end
  end
end
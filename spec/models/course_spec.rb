...
RSpec.describe Course, type: :model do
  ...
  context "subscribable lectures" do
    before :all do
      ...
      term1 = FactoryBot.create(:term, year:, season: "SS")
      term2 = FactoryBot.create(:term, year:, season: "WS")
  ...
  describe "#items" do
    it "returns all items from the lectures of the course" do
      course = FactoryBot.create(:course)
      lecture1 = FactoryBot.create(:lecture_with_sparse_toc, course:)
      lecture2 = FactoryBot.create(:lecture_with_sparse_toc, course:)
  ...
  describe "#users" do
    it "returns the correct users" do
      ...
      FactoryBot.create(:lecture, course:,
  ...
  describe "#addable_by?" do
    ...
    it "returns true if a lecture of the course is edited by user" do
      course = FactoryBot.create(:course)
      FactoryBot.create(:lecture, course:, editors: [@user])
      expect(course.addable_by?(@user)).to be true
    end

    it "returns true if a lecture of the course has the user as teacher" do
      course = FactoryBot.create(:course)
      FactoryBot.create(:lecture, course:, teacher: @user)
      expect(course.addable_by?(@user)).to be true
    end
  ...
  context "media and their items with inheritance" do
    before :all do
      ...
      lecture = FactoryBot.create(:lecture_with_sparse_toc, course: @course,
                                                            term:)
      lesson = FactoryBot.create(:valid_lesson, lecture:)
  ...
  describe "#sections" do
    it "returns all sections of the associated lectures" do
      course = FactoryBot.create(:course)
      lecture1 = FactoryBot.create(:lecture, course:)
      lecture2 = FactoryBot.create(:lecture, course:)
  ...
  describe "#search_by" do
    before :all do
      ...
      @program1 = FactoryBot.create(:program, name: "BSc100", subject:)
      @program2 = FactoryBot.create(:program, name: "BSc50", subject:)

...
- [0 Overview](../../architecture/src/features/00-overview.md)
- [1 Domain Model](../../architecture/src/features/01-domain-model.md)
- [2 Registration](../../architecture/src/features/02-registration.md)
...
- [5 Exam eligibility and grading schemes](../../architecture/src/features/05-exam-eligibility-and-grading-schemes.md)
- [6 End to end workflow](../../architecture/src/features/06-end-to-end-workflow.md)
- [7 Algorithm details](../../architecture/src/features/07-algorithm-details.md)
- [8 Examples and demos](../../architecture/src/features/08-examples-and-demos.md)
- [9 Integrity and invariants](../../architecture/src/features/09-integrity-and-invariants.md)

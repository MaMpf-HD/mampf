...
- RSpec (Ruby). Always run specs with: `VITE_RUBY_PORT=3036 RAILS_ENV=test bundle exec rspec ...`. NEVER run specs with: `bundle exec rspec ...` alone, this will wipe the development database.
- Cypress (JS)

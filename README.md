...
```
That's it. All the rest can be done entirely via the GUI. In a production environment you might want to regularly delete upload caches `/usr/src/app/public/uploads/cache/*` and expired quizzes (`bundle exec rake cleanup:destroy_random_quizzes`).

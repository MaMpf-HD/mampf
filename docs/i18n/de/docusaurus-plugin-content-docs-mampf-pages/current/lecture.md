...
<ul>
  ...
  <li>
     ...
     Der Schnellzugriff ist ein Dropdownmenü, das sich in der Mitte der <a href="/mampf/de/mampf-pages/nav-bar" target="_self">Navigationsleiste</a> befindet. Im ausgeklappten Menü kann die gewünschte Vorlesung ausgewählt werden, sofern sie bereits zum Schnellzugriff hinzugefügt worden ist.
</ul>

...
* <button><img src="https://media.githubusercontent.com/media/MaMpf-HD/mampf/docs/docs/static/img/keyboard-arrow-right_2.png" height="12"/></button> Wechsel auf die Seite des nächsten Vortrags. Dieses Bedienelemente ist nur vorhanden, wenn es sich nicht um den letzten Vortrag handelt.

### Basisdaten
Hier gibt es lediglich <a href="/mampf/de/docs/tag" target="_self"><button name="button">Begriff</button></a>. Dies führt auf die <a href="/mampf/de/docs/tag" target="_self">Seite des Begriffs</a>.

...
<table>
  <tr>
     ...
     <td valign="top">
        <ul>
           <li>
              <button><img src="https://media.githubusercontent.com/media/MaMpf-HD/mampf/docs/docs/static/img/magnifying-glass-solid.png" width="15" height="15"/> Beispiele suchen</button> Wechsel zur Seite „Beispielsuche“.
           </li>      
           <li>

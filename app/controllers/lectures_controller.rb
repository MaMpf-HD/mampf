...
class LecturesController < ApplicationController
  ...
  private
    ...
    def eager_load_stuff
      ...
      @course_tags = @lecture.course_tags(lecture_tags:)
      @extra_tags = @lecture.extra_tags(lecture_tags:)
      @deferred_tags = @lecture.deferred_tags(lecture_tags:)

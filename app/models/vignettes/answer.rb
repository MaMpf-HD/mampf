module Vignettes
  class Answer < ApplicationRecord
    ...
    has_one :slide_statistic, class_name: "Vignettes::SlideStatistic",
                              foreign_key: "vignettes_answer_id", inverse_of: :answer, dependent: :destroy
    ...
    has_and_belongs_to_many :options, class_name: "Vignettes::Option",
                                      join_table: :vignettes_answers_options, association_foreign_key: "vignettes_option_id",

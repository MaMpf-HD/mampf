module DeviseHelper
  # Where the language switch points. On a failed submit the current request is
  # the submit itself, so `url_for` would build that path instead of the form's;
  # the reset form also needs its token carried along.
